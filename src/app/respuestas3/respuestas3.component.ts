...
@Component({
  selector: 'app-respuestas3',
  templateUrl: './respuestas3.component.html',
  styleUrl: './respuestas3.component.scss'
})
export class Respuestas3Component {
  @Input() personaId: any;
    ...
    this.servicio.traer().subscribe(
      (dates: MiObjeto[]) => {
        ...
        if (objetoEncontrado) {
          ...
          this.dieciseis= objetoEncontrado.dieciseis
          this.diecisiete =objetoEncontrado.diecisiete
          this.dieciocho = objetoEncontrado.dieciocho
          this.diecinueve = objetoEncontrado.diecinueve
          this.veinte = objetoEncontrado.veinte
        } else {
